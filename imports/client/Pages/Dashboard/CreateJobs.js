      ...
      <div className="container">
        <form>
          <div className="row">
            <div className="input-field col l6 m6 s12">
              ...
              <label htmlFor="supervisor-name" ref="supervisorName">Supervisors name</label>
            </div>
            <div className="input-field col l6 m6 s12">
              <input id="supervisor-number" type="text"/>
              <label htmlFor="supervisor-number" ref="supervisorNumber">Supervisors number</label>
            </div>
          </div>
          <div className="input-field col l12 m12 s12">
            <input id="jobLocation" type="text"/>
            <label htmlFor="jobLocation" ref="GoogleAuto">Job location</label>
          </div>
          <div className="input-field col l12 m12 s12">
            <input id="job-description" type="text"/>
            <label htmlFor="job-description" ref="jobDescription">Job description</label>
          </div>
          <div className="input-field col l12 m12 s12">
            <input id="responsibility" type="text"/>
            <label htmlFor="responsibility" ref="responsibilites">Responsibilites include:</label>
          </div>
        </form>
        <form>
          <div className="row">
            ...
            <div id="toolDisplay" style={{display:'none'}} className="input-field col l10 m10 s8">
              ...
              <label htmlFor="tools" ref="tools">Required tools:</label>
            </div>
          </div>
        </form>
        <form>
        ...
        <form>
          <div className="input-field col l12 s12">
            <input id="additional-text" type="text"/>
            <label htmlFor="additional-text" ref="additionalText">Additional information:</label>
          </div>
