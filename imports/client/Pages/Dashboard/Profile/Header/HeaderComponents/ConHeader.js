...
export default class ConHeader extends React.Component {
constructor(props) {
  super(props);
  this.state={
    unClickHeight:0,
...
componentDidMount(){
  ...
  let arrayofPaths=['about','reviews','contact'];
        ...
        <div className="row">
          ...
          <div style={{height:'10vh'}} className="row ">
                <div className="col center-align s12 m4 l4 ">
                    <img
                      ...
                      src={'/cfs/files/images/'+this.props.user.profile.employerData.image}
                    />
                </div>
          ...
          <div style={{height:'30px',position:'relative'}}className="row" >
            <div  className="col center-align  s12 m8 l8 offset-l3  offset-m3">
              ...
              <div  style={{paddingRight:'3px',paddingLeft:'3px'}} className="col center-align  s4 m4 l4">
