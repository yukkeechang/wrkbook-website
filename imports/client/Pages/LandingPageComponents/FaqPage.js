                  ...
                  <div className="card blue-grey darken-3">
                    <div className="card-content">
                      <div className="col white-text">
                        <h4  className="center-align flow-text">Frequently Asked Questions</h4>
                        <h4  className="flow-text">What is WrkBook?</h4>
                        ...
                        <h4  className="flow-text">How do I sign up?</h4>
                        ...
                        <h4 className="flow-text">What happens after I sign up?</h4>
                        ...
                        <h4  className="flow-text">How do I get jobs?</h4>
                        ...
                        <h4  className="flow-text">Who pays me?</h4>
                        ...
                        <h4  className="flow-text">Who employs me when I find work through WrkBook?</h4>
                        ...
                        <h4  className="flow-text">Why does WrkBook ask me so many questions when I sign up?</h4>
                        ...
                        <h4  className="flow-text">Is WrkBook a staffing agency or employment agency?</h4>
                        ...
                        <h4  className="flow-text">How much do jobs pay?</h4>
                        ...
                        <h4 className="flow-text">How do I get paid?</h4>
                        ...
                        <h4 className="flow-text">Can I change the types of jobs that I receive?</h4>
                        ...
                        <h4 className="flow-text">Have more questions?</h4>
                        <h6 className="flow-text">E-mail us at <a className="wrkbook-green-text" href="mailto:mail@mail.com?subject=[Information Inquiry]">mail@mail.com</a> or call us at 123-456-7890</h6>
                        {
                          /*
