...
export default class Hero extends Component {
    ...
    render(){
      ...
      hotjar.initialize(790931, 6);
        return (
            <div id="hero" ref="hero" className="ban-med valign-wrapper lozad"  data-background-image="/images/carpet.jpg">
                      ...
                      >
                        <div className="row">
                          <div style={{marginBottom:'10px'}} className="col s12 m6 l6">
                            <Button onClick={this.handleClick} stylez={{width:'100%'}} className="roundish-button-flat-large wrkbook-green" text={"white"}  >Find Work</Button>
                          </div>
                          <div className="col s12 m6 l6">

                            <Button onClick={this.handleClick} stylez={{width:'100%'}} className="roundish-button-flat-large white"  text={"black"} >Find Workers</Button>
                          </div>
