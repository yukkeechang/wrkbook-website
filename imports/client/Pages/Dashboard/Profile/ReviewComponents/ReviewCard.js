      ...
      <div className="card-panel">
        ...
        <div className="row">
          <div className="col s12 m4">
            ...
            <Avatar imageId={this.props.user.profile.employeeData.image} size={this.props.size}/>
            :
              <Avatar imageId={this.props.user.profile.employerData.image} size={this.props.size}/>
            }
