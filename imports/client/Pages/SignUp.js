...
export default class SignUp extends Component {
  ...
  render() {
    ...
    switch (this.state.step) {
      case 1:
        step = <StepOne next={this.next} isPro={this.state.pro} />;
        break;
      case 2:
        step = this.state.pro ? (
          <StepTwoE user={this.state.User} next={this.next} />
        ) : (
          <StepTwoC user={this.state.User} next={this.next} />
        );
        break;
      case 3:
        step = (
        ...
        <div className="wrapper">
          <div className="container">
            <div className="progress">
              <div
                className="determinate red accent-2"
                style={{ width: `${this.state.step * 25}%` }}
              />
            </div>
          </div>
