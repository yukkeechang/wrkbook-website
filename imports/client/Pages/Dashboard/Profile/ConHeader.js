...
<a id="about" ref="about" style={{width:'100%',height:'100%',fontSize:'50%'}} className="waves-effect white waves-light btn-flat" onClick={this.handleClick.bind(this,'about')}>About</a>

              </div>
              <div className="col s4 m4 l4">
                  <a id="contact" ref="contact" style={{width:'100%',height:'100%',fontSize:'50%'}} className="waves-effect white waves-light btn-flat" onClick={this.handleClick.bind(this,'contact')}>Contact</a>
              </div>
              <div className="col  s4 m4 l4">
                  <a id="reviews" ref="reviews" style={{width:'100%',height:'100%',fontSize:'50%'}} className="waves-effect center-align   white waves-light btn-flat" onClick={this.handleClick.bind(this,'reviews')}>Reviews</a>
              </div>
            </div>
          </div>
