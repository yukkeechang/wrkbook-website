        ...
        window.addEventListener('scroll',(e)=> {
            if(this.refs.story){
                window.requestAnimationFrame(()=>{
                    this.refs.story.style.backgroundSize = 'auto ' + (50+ (window.scrollY/30))+'vmax';
                });
            }
